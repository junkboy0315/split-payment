    ...
    trigger('onPersonListChange', [
      transition('* => *', [
        ...
        group([
          ...
          query('.container-of-person-list:enter, .list-group-item:enter', // 'container-of-person-list' is for first entry
          ...
          query('.container-of-person-list:leave, .list-group-item:leave', // 'container-of-person-list' is for last leave
            animate('0.15s ease-out', keyframes([
